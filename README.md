...
> (α=0.023) on UniRef50 next-residue prediction at every scale, gap widening.**
> 117 unit + integration tests. See `docs/v0.5_release_scope.md` and the
> [roadmap](#roadmap).
...
| **v0.6** | next | Cross-architecture benchmark suite (probing + downstream) — design in [`docs/probing_harness_plan.md`](docs/probing_harness_plan.md) |
